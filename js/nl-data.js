...
// NL_SYS_V2 — 디스크립션 활용형. NL_SYS 에 두 가지만 반영(협소함 수정, 나머지 동일):
//  ① get_column 설명을 '형식·코드값·뜻·분류'로 넓힘
//  ② 규칙 2의 코드 리터럴 정식 출처에 get_column.description 추가
//  (※ 신뢰도 완화는 제외 — 별개 변경이고 사이드이펙트 확인됨)
...
const NL_PROMPTS = [
  ...
  { id: "desc_active", label: "디스크립션 활용형 — get_column 코드·뜻 활용 + 코드 출처 인정", system: NL_SYS_V2 },
];
